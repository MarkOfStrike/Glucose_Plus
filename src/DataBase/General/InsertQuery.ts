...
import {
    FOOD_RECORD_TABLE, FOOD_RECORD_TABLE_FOOD_ID, FOOD_RECORD_TABLE_PRODUCT_ID, FOOD_TABLE,
    FOOD_TABLE_DATE_ADD, FOOD_TABLE_NAME, PRODUCT_GROUP_TABLE, PRODUCT_GROUP_TABLE_ID,
    PRODUCT_GROUP_TABLE_NAME, PRODUCTS_TABLE, PRODUCTS_TABLE_CARBOHYDRATES, PRODUCTS_TABLE_FATS,
    PRODUCTS_TABLE_GI, PRODUCTS_TABLE_GROUP, PRODUCTS_TABLE_NAME, PRODUCTS_TABLE_PROTEINS,
    PRODUCTS_TABLE_XE
} from '../DataBaseConst';
